class Ghst_RscText_WS : GOMRscText{
    type = CT_STATIC;
    style = ST_LEFT;
    idc = -1;
...
class Ghst_RscStructuredText_WS : GOMRscStructuredText{
...
class Ghst_RscButton_WS : GOMRscButton {
    type = CT_BUTTON;
    style = ST_CENTER;
    idc = -1;
    font = GUI_FONT_NORMAL;
...
class Ghst_RscListBox_WS : GOMRscListBox{
    type = CT_LISTBOX;
    style = ST_LEFT;
    idc = -1;
    /*
...
class Ghst_RscPictureKeepAspect_WS : GOMRscPictureKeepAspect {
    type = CT_STATIC;
