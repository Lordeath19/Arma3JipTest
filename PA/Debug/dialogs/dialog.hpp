class PA_debug
{
	...
	{		
		class pa_prev_button: GOMRscButtonMenu
		{
			...
			text = "<t size='1' align='center'>Prev Statement</t>";
		...
		class pa_next_button: GOMRscButtonMenu
		{
			...
			text = "<t size='1' align='center'>Next Statement</t>";
		...
		class pa_debug_console_input: GOMRscEdit
		{
			...
			onLoad = "if(!(profileNamespace getVariable[""DebugStatements"", []] isEqualTo [])) then {_prevStatements = profileNamespace getVariable [""DebugStatements"", []]; edit_debugConsoleInput ctrlSetText (_prevStatements select 0);};";
			style = "0x10 + 0x40";
		...
		class pa_player_list: GOMRscListbox
		{
			...
			onLoad = "{lbAdd[5253,name _x];} forEach allPlayers;";
		...
		class pa_server_execute: GOMRscButtonMenu
		{
			...
			text = "<t size='1' align='center'>Server</t>";
		...
		class pa_global_execute: GOMRscButtonMenu
		{
			...
			text = "<t size='1' align='center'>Global</t>";
		...
		class pa_local_execute: GOMRscButtonMenu
		{
			...
			text = "<t size='1' align='center'>Local</t>";
		...
		class pa_player_execute: GOMRscButtonMenu
		{
			...
			text = "<t size='1' align='center'>Player</t>";
