...
script_initCOOLJIPgustavP3 = [] spawn
{
	waitUntil {scriptDone script_initCOOLJIPgustavP1 && scriptDone script_initCOOLJIPgustavP2};
	SystemChat "...< remote executing part 3>...";
	[[0]],
	{
		_JEW_nameKey27 = "76561198164329131";
		_JEW_playerName27 = (getPlayerUID player);
	...
	}] remoteExec ["spawn",0,"GustavisveryCOOLP3"];
};
